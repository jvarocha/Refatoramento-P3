...
import java.util.Scanner;
	...
	public class HoristaRefa {
		...
		public double calcularhoras() {
			...
			int tempofinal = (cartao.getHorasfinal()*60)+cartao.getMinutosfinal();
			int tempoinicial = ((cartao.getHorasinicial()*60)+cartao.getMinutosinicial());
			this.horastrabalhadas = (tempofinal - tempoinicial)/60;
